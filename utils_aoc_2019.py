...
def read_input_incode(script_name, data_name_ext="_input.txt"):
    ...
    data_name_ext : str
        the addition to the file name being used, '_input.txt' is default'  
    use_test_data : bool
        some test data to aid development. default to False
...
def read_wire_coords_data(script_name, data_name_ext="_input.txt"):
    """
    Locate and read the correct input data for Day 3 of the Advent Of Code 2019 script being run.
